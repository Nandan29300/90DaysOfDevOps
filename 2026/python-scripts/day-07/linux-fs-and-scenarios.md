...
**What I learned:** Service troubleshooting follows a pattern: status → logs → manual start → dependencies.
...
- Group can read (`r--`)
- Others can read (`r--`)
- **No execute permission** (`x`) for anyone → This is the problem!
...
- ✅ **Finding logs** when services fail
- ✅ **Locating configuration files** for applications
- ✅ **Understanding where binaries** are installed
- ✅ **Writing scripts** that work across different systems
- ✅ **Troubleshooting deployment** issues
- ✅ **Security auditing** and access control

## Scenario-Based Practice Prepares You For:
- ✅ **Real production incidents** - When services go down at 2 AM
- ✅ **DevOps interviews** - These exact scenarios are asked
- ✅ **On-call troubleshooting** - Under pressure with time constraints
- ✅ **Collaborating with developers** - Speaking the same language
